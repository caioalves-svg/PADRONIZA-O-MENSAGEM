...
def pagina_dashboard():
    ...
    st.markdown(
        ...
        'padding:0.65rem 1rem;margin-top:1rem;font-size:0.88rem;color:#166534">'
        '📂 Para consultar registros individuais, use <strong>Histórico de Atendimentos</strong> no menu lateral.'
        '</div>',
        unsafe_allow_html=True,
    )
