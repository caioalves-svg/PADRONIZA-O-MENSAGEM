...
modelos_pendencias = {
    ...
    "REENTREGA AUTORIZADA": """Olá, {nome_cliente}! Tudo bem? Esperamos que sim!\n\nConforme conversamos, solicitamos que a transportadora realize uma nova tentativa de entrega do seu pedido. O prazo previsto para a finalização é de 3 a 5 dias úteis, dentro do horário comercial (podendo ocorrer antes).\n\nPedimos sinceras desculpas pelo transtorno causado e seguimos acompanhando o seu caso até a entrega.\n\nAtenciosamente,\n{colaborador}""",
    "AVARIA": """Olá, {nome_cliente}! Tudo bem? Esperamos que sim!\n\nInfelizmente, fomos informados pela transportadora que sua mercadoria sofreu uma avaria durante o transporte. Pedimos sinceras desculpas pelo ocorrido e por todo o transtorno causado.\n\nPara resolvermos da melhor forma, você aceitaria o envio de um novo produto? O prazo de entrega é de 5 a 7 dias úteis, podendo ocorrer antes.\n\nNovamente, pedimos desculpas e seguimos à disposição para ajudá-lo!\n\nAtenciosamente,\n{colaborador}""",
    "EXTRAVIO": """Olá, {nome_cliente}! Tudo bem? Esperamos que sim!\n\nInfelizmente, fomos informados pela transportadora que sua mercadoria foi extraviada durante o transporte. Pedimos sinceras desculpas pelo ocorrido e por todo o transtorno causado.\n\nPara resolvermos da melhor forma, você aceitaria o envio de um novo produto? O prazo de entrega é de 5 a 7 dias úteis, podendo ocorrer antes.\n\nNovamente, pedimos desculpas e seguimos à disposição para ajudá-lo!\n\nAtenciosamente,\n{colaborador}""",
    "EXTRAVIO / AVARIA (SEM ESTOQUE)": """Olá, {nome_cliente}! Tudo bem? Esperamos que sim!\n\nInfelizmente, fomos informados pela transportadora que sua mercadoria sofreu um imprevisto (extravio/avaria) durante o transporte. Verificamos em nosso sistema e, no momento, não temos este item em estoque para reposição.\n\nDiante disso, podemos seguir com o cancelamento da compra e o estorno do valor? Pedimos sinceras desculpas por todo o transtorno causado.\n\nQualquer dúvida, estamos à disposição!\n\nAtenciosamente,\n{colaborador}"""
}
