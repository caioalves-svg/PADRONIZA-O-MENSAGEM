...
modelos_pendencias = {
    ...
    "ACAREAÇÃO": """Olá, (Nome do cliente)! Tudo bem? Esperamos que sim!\n\nIdentificamos uma divergência na entrega do seu pedido e, por isso, abrimos um chamado de acareação com a transportadora. Neste procedimento, o motorista retorna ao local para identificar quem recebeu a mercadoria e validar as informações fornecidas. O prazo para a conclusão desta análise é de até 7 dias úteis. Assim que tivermos o parecer final, entraremos em contato imediatamente com a resolução.\n\nAtenciosamente,\n{colaborador}""",
}
